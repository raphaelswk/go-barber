...
## 💇🏻‍♂️ About the project
The Mobile Client is to be used by the Customers and they will be able to see the list of barbers registered on the app, their availability and make appointments.

To see the **api**, click here: [GoBarber Rest API](https://github.com/raphaelswk/go-barber/tree/main/gobarber-backend)</br>
To see the **web client**, click here: [GoBarber Web](https://github.com/raphaelswk/go-barber/tree/main/gobarber-web)
...
- Having this application's [API](https://github.com/raphaelswk/go-barber/tree/main/gobarber-backend) running

**Clone the project and access the folder**

```bash
$ git clone https://github.com/raphaelswk/go-barber.git && cd go-barber/gobarber-mobile
```
