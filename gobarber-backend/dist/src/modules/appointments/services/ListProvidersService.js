            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        providers = _b.sent();
                        if (!providers) {
                            throw new AppError_1.default('No providers found');
                        }
                        return [4 /*yield*/, this.cacheProvider.save("providers-list:" + user_id, class_transformer_1.classToClass(providers))];
                    case 3:
                        _b.sent();
                        _b.label = 4;
