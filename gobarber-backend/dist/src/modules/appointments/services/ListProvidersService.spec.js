...
var FakeUserRepository_1 = __importDefault(require("@modules/users/repositories/fakes/FakeUserRepository"));
...
describe('ListProviders', function () {
    beforeEach(function () {
        ...
        listProvider = new ListProvidersService_1.default(fakeUserRepository, fakeCacheProvider);
    });
