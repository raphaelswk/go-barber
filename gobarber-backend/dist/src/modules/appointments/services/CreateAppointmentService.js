                ...
                switch (_b.label) {
                    case 0:
                        ...
                        if (user_id === provider_id) {
                            throw new AppError_1.default("You can't create an appointment for yourself.");
                        }
                        if (date_fns_1.getHours(appointmentDate) < 8 || date_fns_1.getHours(appointmentDate) > 17) {
                            throw new AppError_1.default("You can only create appointmentss between 8am and 5pm ");
                        }
                    ...
                    case 2:
                        appointment = _b.sent();
                        formattedDate = date_fns_1.format(appointmentDate, "dd/MM/yyyy 'at' HH:mm");
