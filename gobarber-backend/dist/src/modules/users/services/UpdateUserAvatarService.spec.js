...
describe('UpdateUserAvatar', function () {
    ...
    it('should be able to update an avatar', function () { return __awaiter(void 0, void 0, void 0, function () {
        var user;
    ...
    it('should not be able to update the avatar for an unauthenticated user', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
